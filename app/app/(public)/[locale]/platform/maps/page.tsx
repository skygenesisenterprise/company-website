...
export default async function PlatformMapsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const products = [
    {
      icon: Map,
      title: t("home.platform.interactiveMaps"),
      description: t("home.platform.mapsDesc"),
    },
    {
      icon: Navigation,
      title: t("home.platform.routing"),
      description: t("home.platform.mapsDesc"),
    },
    {
      icon: Pin,
      title: t("home.platform.geocoding"),
      description: t("home.platform.mapsDesc"),
    },
    {
      icon: MapPin,
      title: t("home.platform.locationServices"),
      description: t("home.platform.mapsDesc"),
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground leading-tight text-balance">
                {t("home.platform.mapsTitle")}
              </h1>
              <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                {t("home.platform.mapsDesc")}
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.map((product) => (
                <div key={product.title} className="p-6 rounded-lg border border-border bg-card hover:border-foreground/20 transition-colors group">
                  ...
                  <span className={`text-sm font-semibold flex items-center gap-1 text-orange-400 hover:opacity-80 transition-opacity`}>
