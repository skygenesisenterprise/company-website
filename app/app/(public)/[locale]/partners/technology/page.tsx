...
export default async function PartnersTechnologyPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const features = [
    {
      icon: Code,
      title: tPartners("techFeature1Title"),
      description: tPartners("techFeature1Desc"),
    },
    {
      icon: Layers,
      title: tPartners("techFeature2Title"),
      description: tPartners("techFeature2Desc"),
    },
    {
      icon: Server,
      title: tPartners("techFeature3Title"),
      description: tPartners("techFeature3Desc"),
    },
    {
      icon: FileCheck,
      title: tPartners("techFeature4Title"),
      description: tPartners("techFeature4Desc"),
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground leading-tight text-balance">
                {tPartners("techHeroTitle")}
              </h1>
              <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                {tPartners("techHeroDescription")}
              </p>
