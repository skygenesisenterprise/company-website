...
export default async function PartnersServicePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const features = [
    {
      icon: Code,
      title: tPartners("serviceFeature1Title"),
      description: tPartners("serviceFeature1Desc"),
    },
    {
      icon: Layers,
      title: tPartners("serviceFeature2Title"),
      description: tPartners("serviceFeature2Desc"),
    },
    {
      icon: Server,
      title: tPartners("serviceFeature3Title"),
      description: tPartners("serviceFeature3Desc"),
    },
    {
      icon: FileCheck,
      title: tPartners("serviceFeature4Title"),
      description: tPartners("serviceFeature4Desc"),
    },
  ];
