...
export default async function PartnersBecomePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const features = [
    {
      icon: Code,
      title: tPartners("becomeFeature1Title"),
      description: tPartners("becomeFeature1Desc"),
    },
    {
      icon: Layers,
      title: tPartners("becomeFeature2Title"),
      description: tPartners("becomeFeature2Desc"),
    },
    {
      icon: Server,
      title: tPartners("becomeFeature3Title"),
      description: tPartners("becomeFeature3Desc"),
    },
    {
      icon: FileCheck,
      title: tPartners("becomeFeature4Title"),
      description: tPartners("becomeFeature4Desc"),
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground leading-tight text-balance">
                {tPartners("becomeHeroTitle")}
              </h1>
              <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                {tPartners("becomeHeroDescription")}
              </p>
