...
export default async function PartnersDistributionPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const features = [
    {
      icon: Code,
      title: tPartners("distributionFeature1Title"),
      description: tPartners("distributionFeature1Desc"),
    },
    {
      icon: Layers,
      title: tPartners("distributionFeature2Title"),
      description: tPartners("distributionFeature2Desc"),
    },
    {
      icon: Server,
      title: tPartners("distributionFeature3Title"),
      description: tPartners("distributionFeature3Desc"),
    },
    {
      icon: FileCheck,
      title: tPartners("distributionFeature4Title"),
      description: tPartners("distributionFeature4Desc"),
    },
  ];
