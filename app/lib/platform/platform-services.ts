...
export interface PlatformAvailabilityItem {
  label: string;
  value: PlatformServiceStatus | "In progress" | "Not available" | "Limited" | "Internal";
}
...
export const platformServices: Record<PlatformServiceSlug, PlatformService> = {
  identity: {
    ...
    availability: [
      ...
      { label: "Public API", value: "Limited" },
      { label: "Dashboard integration", value: "Available" },
      { label: "Documentation", value: "In progress" },
      { label: "Workspace integration", value: "Available" },
    ],
    ctas: [
      { label: "Developers", href: "/developers", variant: "primary" },
  ...
  vault: {
    ...
    availability: [
      ...
      { label: "Public API", value: "Planned" },
      { label: "Dashboard integration", value: "In progress" },
      { label: "Documentation", value: "In progress" },
  ...
  status: {
    ...
    ctas: [
      { label: "Explore Developers", href: "/developers", variant: "primary" },
      { label: "Contact", href: "/company/contact", variant: "secondary" },
    ],
  ...
  search: {
    ...
    integrations: ["CMS pages", "Docs", "Products", "Developers", "Workspace"],
    ...
    availability: [
      { label: "Current status", value: "In development" },
      { label: "Public API", value: "Planned" },
      { label: "Dashboard integration", value: "Planned" },
      { label: "Documentation", value: "In progress" },
      { label: "Workspace integration", value: "Planned" },
    ],
    ctas: [
  ...
  edge: {
    slug: "edge",
    title: "Edge",
    promise: "Routing and delivery foundations for SGE public and platform services.",
    description:
      "Sky Genesis Edge describes the routing, traffic control and delivery layer planned for resilient SGE service access.",
    status: "In development",
    purpose: {
  ...
  maps: {
    ...
    availability: [
      ...
      { label: "Public API", value: "Research" },
      { label: "Dashboard integration", value: "Planned" },
      { label: "Documentation", value: "Planned" },
      { label: "Workspace integration", value: "Planned" },
    ],
  ...
  bank: {
    ...
    availability: [
      { label: "Current status", value: "Research" },
